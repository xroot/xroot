...
path_conf_disp_file = os.path.join(base_dir, "config", "display_settings.ini")
path_conf_rules_file = os.path.join(base_dir, "config", "game_settings.ini")
path_conf_language_file = os.path.join(base_dir, "config", "ui_content.ini")
